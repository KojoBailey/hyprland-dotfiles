return {
	...
	fileManager = "dolphin",
	screenshotAreaTool = "grim -g \"$(slurp)\" - | tee ~/Pictures/screenshots/$(date +%Y%m%d_%H:%M:%S).png | wl-copy",
	screenshotScreenTool = "grim - | tee ~/Pictures/screenshots/$(date +%Y%m%d_%H:%M:%S).png | wl-copy",
}
